...
export default function ContabilitySignUp() {
	const {
		register,
		handleSubmit,
		formState: { errors },
	...
	async function handleCreateContability(formData: FieldValues) {
		...
		>
			...
			>
				<Image
					...
					height={100}
				/>
				<Form onSubmit={handleSubmit(handleCreateContability)}>
